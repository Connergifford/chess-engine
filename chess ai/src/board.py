        ...
        for row in range(ROWS):
            for col in range(COLS):
                if isinstance (self.squares[row][col].piece, Pawn):
                    ...
                    if self.last_move:
                        if self.last_move.final.piece != None:
    ...
    def calc_moves(self, piece, row, col, bool=True):
            ...
            for possible_move_row in range(start, end, piece.dir):
                if Square.in_range(possible_move_row):
                    if self.squares[possible_move_row][col].isempty:
                        # create init and final move squares
                        initial = Square(row, col)
                        final = Square(possible_move_row, col)
                        #create new move
                        move = Move(initial, final)
                        
                        #check potetial checking moves
                        if bool:
        ...
        def straightline_moves(incrs):
            for incr in incrs:
                ...
                while True:
                    if Square.in_range(possible_move_row, possible_move_col):
                        #create a square of the possible new move
                        initial = Square(row, col)
                        final_piece = self.squares[possible_move_row][possible_move_col].piece
                        final = Square(possible_move_row, possible_move_col, final_piece)
            ...
            #queen castling
                ...
                if isinstance(left_rook, Rook):
                    if not left_rook.moved:
                        for c in range(1, 4):
                            #castling is not possible because there are pieces in the squares needed.
